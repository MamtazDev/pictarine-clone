              ...
              <div className="col-lg-8">
                <div className="left-block-business">
                  ...
                  <div className="container-number">
                    <div className="row">
                      {t('businessInfo', { returnObjects: true }).map((data, index) => {
                        return (
              ...
              <div className="col-lg-6">
                <div className="g-container-meetup">
                  <div className="left-block-meetup">
                    ...
                    <p className="date-meetup">Juin 2022 @ Pictarine</p>
                    <p>
                      {t('meetUpPictaDes3')}
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div className="form">
                    ...
                    <div className="d-flex justify-content-end">
                      <button className="button-picta btn_picta">{t('mailBtn')}</button>
                    </div>
            ...
            <div className="g-findus">
              ...
              <div className="g-container-cards">
                <div className="row">
                  ...
                  {
                    t('blogCards', { returnObjects: true }).map((data, index) => (
